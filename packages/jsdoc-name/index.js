...
// TODO: docs
exports.puncToScope = _.invert(scopeToPunc);
...
/**
 * Given a longname like `a.b#c(2)`, split it into the following properties:
 *
 * + `longname`
 * + `memberof`
 * + `scope`
 ...
 * + `variation`
 *
 * @param {string} longname - The longname to
 * @param {string} forcedMemberof
 * @returns {object} Representing the properties of the given name.
 */
const atomize = exports.atomize = (longname, forcedMemberof) => slice(
...
exports.applyNamespace = (longname, ns) => {
    const nameParts = atomize(longname);
...
exports.hasAncestor = (parent, child) => {
    ...
    do {
        memberof = atomize(memberof).memberof;
