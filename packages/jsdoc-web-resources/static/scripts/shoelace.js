...
`,ef=Object.defineProperty,eg=Object.defineProperties,eb=Object.getOwnPropertyDescriptor,ey=Object.getOwnPropertyDescriptors,e_=Object.getOwnPropertySymbols,ew=Object.prototype.hasOwnProperty,ex=Object.prototype.propertyIsEnumerable,e$=(e,t,i)=>t in e?ef(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,ek=(e,t)=>{for(var i in t||(t={}))ew.call(t,i)&&e$(e,i,t[i]);if(e_)for(var i of e_(t))ex.call(t,i)&&e$(e,i,t[i]);return e},eA=(e,t)=>eg(e,ey(t)),eC=(e,t,i,s)=>{for(var r,o=s>1?void 0:s?eb(t,i):t,n=e.length-1;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&ef(t,i,o),o},eE=new WeakMap,eS=new WeakMap,ez=new WeakSet,eI=new WeakMap,eT=class{constructor(e,t){this.handleFormData=e=>{let t=this.options.disabled(this.host),i=this.options.name(this.host),s=this.options.value(this.host),r="sl-button"===this.host.tagName.toLowerCase();t||r||"string"!=typeof i||!(i.length>0)||void 0===s||(Array.isArray(s)?s.forEach(t=>{e.formData.append(i,t.toString())}):e.formData.append(i,s.toString()))},this.handleFormSubmit=e=>{var t;let i=this.options.disabled(this.host),s=this.options.reportValidity;this.form&&!this.form.noValidate&&(null==(t=eE.get(this.form))||t.forEach(e=>{this.setUserInteracted(e,!0)})),!this.form||this.form.noValidate||i||s(this.host)||(e.preventDefault(),e.stopImmediatePropagation())},this.handleFormReset=()=>{this.options.setValue(this.host,this.options.defaultValue(this.host)),this.setUserInteracted(this.host,!1),eI.set(this.host,[])},this.handleInteraction=e=>{let t=eI.get(this.host);t.includes(e.type)||t.push(e.type),t.length===this.options.assumeInteractionOn.length&&this.setUserInteracted(this.host,!0)},this.reportFormValidity=()=>{if(this.form&&!this.form.noValidate){let e=this.form.querySelectorAll("*");for(let t of e)if("function"==typeof t.reportValidity&&!t.reportValidity())return!1}return!0},(this.host=e).addController(this),this.options=ek({form:e=>{if(e.hasAttribute("form")&&""!==e.getAttribute("form")){let t=e.getRootNode(),i=e.getAttribute("form");if(i)return t.getElementById(i)}return e.closest("form")},name:e=>e.name,value:e=>e.value,defaultValue:e=>e.defaultValue,disabled:e=>{var t;return null!=(t=e.disabled)&&t},reportValidity:e=>"function"!=typeof e.reportValidity||e.reportValidity(),setValue:(e,t)=>e.value=t,assumeInteractionOn:["sl-input"]},t)}hostConnected(){let e=this.options.form(this.host);e&&this.attachForm(e),eI.set(this.host,[]),this.options.assumeInteractionOn.forEach(e=>{this.host.addEventListener(e,this.handleInteraction)})}hostDisconnected(){this.detachForm(),eI.delete(this.host),this.options.assumeInteractionOn.forEach(e=>{this.host.removeEventListener(e,this.handleInteraction)})}hostUpdated(){let e=this.options.form(this.host);e||this.detachForm(),e&&this.form!==e&&(this.detachForm(),this.attachForm(e)),this.host.hasUpdated&&this.setValidity(this.host.validity.valid)}attachForm(e){e?(this.form=e,eE.has(this.form)?eE.get(this.form).add(this.host):eE.set(this.form,new Set([this.host])),this.form.addEventListener("formdata",this.handleFormData),this.form.addEventListener("submit",this.handleFormSubmit),this.form.addEventListener("reset",this.handleFormReset),eS.has(this.form)||(eS.set(this.form,this.form.reportValidity),this.form.reportValidity=()=>this.reportFormValidity())):this.form=void 0}detachForm(){var e;this.form&&(null==(e=eE.get(this.form))||e.delete(this.host),this.form.removeEventListener("formdata",this.handleFormData),this.form.removeEventListener("submit",this.handleFormSubmit),this.form.removeEventListener("reset",this.handleFormReset),eS.has(this.form)&&(this.form.reportValidity=eS.get(this.form),eS.delete(this.form))),this.form=void 0}setUserInteracted(e,t){t?ez.add(e):ez.delete(e),e.requestUpdate()}doAction(e,t){if(this.form){let i=document.createElement("button");i.type=e,i.style.position="absolute",i.style.width="0",i.style.height="0",i.style.clipPath="inset(50%)",i.style.overflow="hidden",i.style.whiteSpace="nowrap",t&&(i.name=t.name,i.value=t.value,["formaction","formenctype","formmethod","formnovalidate","formtarget"].forEach(e=>{t.hasAttribute(e)&&i.setAttribute(e,t.getAttribute(e))})),this.form.append(i),i.click(),i.remove()}}getForm(){var e;return null!=(e=this.form)?e:null}reset(e){this.doAction("reset",e)}submit(e){this.doAction("submit",e)}setValidity(e){let t=this.host,i=!!ez.has(t),s=!!t.required;t.toggleAttribute("data-required",s),t.toggleAttribute("data-optional",!s),t.toggleAttribute("data-invalid",!e),t.toggleAttribute("data-valid",e),t.toggleAttribute("data-user-invalid",!e&&i),t.toggleAttribute("data-user-valid",e&&i)}updateValidity(){let e=this.host;this.setValidity(e.validity.valid)}emitInvalidEvent(e){let t=new CustomEvent("sl-invalid",{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.host.dispatchEvent(t)||null==e||e.preventDefault()}},eL=Object.freeze({badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:!0,valueMissing:!1});Object.freeze(eA(ek({},eL),{valid:!1,valueMissing:!0})),Object.freeze(eA(ek({},eL),{valid:!1,customError:!0}));var eU="",eM={caret:`
  ...
  `},eO=[{name:"default",resolver:e=>(function(e=""){if(!eU){let e=[...document.getElementsByTagName("script")],t=e.find(e=>e.hasAttribute("data-shoelace"));if(t)eU=t.getAttribute("data-shoelace");else{let t=e.find(e=>/shoelace(\.min)?\.js($|\?)/.test(e.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(e.src)),i="";t&&(i=t.getAttribute("src")),eU=i.split("/").slice(0,-1).join("/")}}return eU.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")})(`assets/icons/${e}.svg`)},{name:"system",resolver:e=>e in eM?`data:image/svg+xml,${encodeURIComponent(eM[e])}`:""}],eP=[];function eN(e){return eO.find(t=>t.name===e)}var eF=l`
  ${eu}
...
`;function eR(e,t){let i=ek({waitUntilFirstUpdate:!1},t);return(t,s)=>{let{update:r}=t,o=Array.isArray(e)?e:[e];t.update=function(e){o.forEach(t=>{if(e.has(t)){let r=e.get(t),o=this[t];r!==o&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[s](r,o)}}),r.call(this,e)}}}let eB=(e,t)=>"method"!==t.kind||!t.descriptor||"value"in t.descriptor?{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(i){i.createProperty(t.key,e)}}:{...t,finisher(i){i.createProperty(t.key,e)}},eV=(e,t,i)=>{t.constructor.createProperty(i,e)};function eH(e){return(t,i)=>void 0!==i?eV(e,t,i):eB(e,t)}function eD(e){return eH({...e,state:!0})}let ej=({finisher:e,descriptor:t})=>(i,s)=>{var r;if(void 0===s){let s=null!==(r=i.originalKey)&&void 0!==r?r:i.key,o=null!=t?{kind:"method",placement:"prototype",key:s,descriptor:t(i.key)}:{...i,key:s};return null!=e&&(o.finisher=function(t){e(t,s)}),o}{let r=i.constructor;void 0!==t&&Object.defineProperty(i,s,t(s)),null==e||e(r,s)}};function eq(e,t){return ej({descriptor:i=>{let s={get(){var t,i;return null!==(i=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector(e))&&void 0!==i?i:null},enumerable:!0,configurable:!0};if(t){let t="symbol"==typeof i?Symbol():"__"+i;s.get=function(){var i,s;return void 0===this[t]&&(this[t]=null!==(s=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(e))&&void 0!==s?s:null),this[t]}}return s}})}null!=(null===(eh=window.HTMLSlotElement)||void 0===eh?void 0:eh.prototype.assignedElements)||((e,t)=>e.assignedNodes(t).filter(e=>e.nodeType===Node.ELEMENT_NODE));var eW=class extends er{constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let i=new CustomEvent(e,ek({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){let s=customElements.get(e);if(!s){customElements.define(e,class extends t{},i);return}let r=" (unknown version)",o=r;"version"in t&&t.version&&(r=" v"+t.version),"version"in s&&s.version&&(o=" v"+s.version),r&&o&&r===o||console.warn(`Attempted to register <${e}>${r}, but <${e}>${o} has already been registered.`)}};eW.version="2.9.0",eW.dependencies={},eC([eH()],eW.prototype,"dir",2),eC([eH()],eW.prototype,"lang",2);let{I:eK}={O:x,P:$,A:k,C:1,M:q,L:Y,D:I,R:K,I:Z,V:J,H:X,N:ee,U:G,F:et},eY=(e,t)=>void 0===t?void 0!==(null==e?void 0:e._$litType$):(null==e?void 0:e._$litType$)===t,eZ=e=>void 0===e.strings,eJ={},eG=(e,t=eJ)=>e._$AH=t;var eQ=Symbol(),eX=Symbol(),e0=new Map,e1=class extends eW{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var i;let s;if(null==t?void 0:t.spriteSheet)return B`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`;try{if(!(s=await fetch(e,{mode:"cors"})).ok)return 410===s.status?eQ:eX}catch(e){return eX}try{let e=document.createElement("div");e.innerHTML=await s.text();let t=e.firstElementChild;if((null==(i=null==t?void 0:t.tagName)?void 0:i.toLowerCase())!=="svg")return eQ;ec||(ec=new DOMParser);let r=ec.parseFromString(t.outerHTML,"text/html"),o=r.body.querySelector("svg");if(!o)return eQ;return o.part.add("svg"),document.adoptNode(o)}catch(e){return eQ}}connectedCallback(){super.connectedCallback(),eP.push(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){var e;super.disconnectedCallback(),e=this,eP=eP.filter(t=>t!==e)}getIconSource(){let e=eN(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){let e="string"==typeof this.label&&this.label.length>0;e?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;let{url:t,fromLibrary:i}=this.getIconSource(),s=i?eN(this.library):void 0;if(!t){this.svg=null;return}let r=e0.get(t);if(r||(r=this.resolveIcon(t,s),e0.set(t,r)),!this.initialRender)return;let o=await r;if(o===eX&&e0.delete(t),t===this.getIconSource().url){if(eY(o)){this.svg=o;return}switch(o){case eX:case eQ:this.svg=null,this.emit("sl-error");break;default:this.svg=o.cloneNode(!0),null==(e=null==s?void 0:s.mutator)||e.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};e1.styles=eF,eC([eD()],e1.prototype,"svg",2),eC([eH({reflect:!0})],e1.prototype,"name",2),eC([eH()],e1.prototype,"src",2),eC([eH()],e1.prototype,"label",2),eC([eH({reflect:!0})],e1.prototype,"library",2),eC([eR("label")],e1.prototype,"handleLabelChange",1),eC([eR(["name","src","library"])],e1.prototype,"setIcon",1);let e2={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},e5=e=>(...t)=>({_$litDirective$:e,values:t});class e8{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}let e3=e5(class extends e8{constructor(e){var t;if(super(e),e.type!==e2.ATTRIBUTE||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var i,s;if(void 0===this.it){for(let s in this.it=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e))),t)!t[s]||(null===(i=this.nt)||void 0===i?void 0:i.has(s))||this.it.add(s);return this.render(t)}let r=e.element.classList;for(let e in this.it.forEach(e=>{e in t||(r.remove(e),this.it.delete(e))}),t){let i=!!t[e];i===this.it.has(e)||(null===(s=this.nt)||void 0===s?void 0:s.has(e))||(i?(r.add(e),this.it.add(e)):(r.remove(e),this.it.delete(e)))}return V}}),e6=e=>null!=e?e:H,e7=e5(class extends e8{constructor(e){if(super(e),e.type!==e2.PROPERTY&&e.type!==e2.ATTRIBUTE&&e.type!==e2.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!eZ(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===V||t===H)return t;let i=e.element,s=e.name;if(e.type===e2.PROPERTY){if(t===i[s])return V}else if(e.type===e2.BOOLEAN_ATTRIBUTE){if(!!t===i.hasAttribute(s))return V}else if(e.type===e2.ATTRIBUTE&&i.getAttribute(s)===t+"")return V;return eG(e),t}});var e4=class extends eW{constructor(){super(...arguments),this.formControlController=new eT(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){return B`
      <label
        part="base"
        class=${e3({checkbox:!0,"checkbox--checked":this.checked,"checkbox--disabled":this.disabled,"checkbox--focused":this.hasFocus,"checkbox--indeterminate":this.indeterminate,"checkbox--small":"small"===this.size,"checkbox--medium":"medium"===this.size,"checkbox--large":"large"===this.size})}
      >
        <input
          ...
          name=${this.name}
          value=${e6(this.value)}
          .indeterminate=${e7(this.indeterminate)}
          .checked=${e7(this.checked)}
    ...
    `}};e4.styles=ev,e4.dependencies={"sl-icon":e1},eC([eq('input[type="checkbox"]')],e4.prototype,"input",2),eC([eD()],e4.prototype,"hasFocus",2),eC([eH()],e4.prototype,"title",2),eC([eH()],e4.prototype,"name",2),eC([eH()],e4.prototype,"value",2),eC([eH({reflect:!0})],e4.prototype,"size",2),eC([eH({type:Boolean,reflect:!0})],e4.prototype,"disabled",2),eC([eH({type:Boolean,reflect:!0})],e4.prototype,"checked",2),eC([eH({type:Boolean,reflect:!0})],e4.prototype,"indeterminate",2),eC([((e="value")=>(t,i)=>{let s=t.constructor,r=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(t,o,n){var l;let a=s.getPropertyOptions(e),d="string"==typeof a.attribute?a.attribute:e;if(t===d){let t=a.converter||m,s="function"==typeof t?t:null!=(l=null==t?void 0:t.fromAttribute)?l:m.fromAttribute,r=s(n,a.type);this[e]!==r&&(this[i]=r)}r.call(this,t,o,n)}})("checked")],e4.prototype,"defaultChecked",2),eC([eH({reflect:!0})],e4.prototype,"form",2),eC([eH({type:Boolean,reflect:!0})],e4.prototype,"required",2),eC([eR("disabled",{waitUntilFirstUpdate:!0})],e4.prototype,"handleDisabledChange",1),eC([eR(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],e4.prototype,"handleStateChange",1);var e9=l`
  ${eu}
...
`;let te=new Set,tt=new MutationObserver(to),ti=new Map,ts=document.documentElement.dir||"ltr",tr=document.documentElement.lang||navigator.language;function to(){ts=document.documentElement.dir||"ltr",tr=document.documentElement.lang||navigator.language,[...te.keys()].map(e=>{"function"==typeof e.requestUpdate&&e.requestUpdate()})}tt.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]});class tn{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){te.add(this.host)}hostDisconnected(){te.delete(this.host)}dir(){return`${this.host.dir||ts}`.toLowerCase()}lang(){return`${this.host.lang||tr}`.toLowerCase()}getTranslationData(e){var t,i;let s=new Intl.Locale(e),r=null==s?void 0:s.language.toLowerCase(),o=null!==(i=null===(t=null==s?void 0:s.region)||void 0===t?void 0:t.toLowerCase())&&void 0!==i?i:"",n=ti.get(`${r}-${o}`),l=ti.get(r);return{locale:s,language:r,region:o,primary:n,secondary:l}}exists(t,i){var s;let{primary:r,secondary:o}=this.getTranslationData(null!==(s=i.lang)&&void 0!==s?s:this.lang());return i=Object.assign({includeFallback:!1},i),!!r&&!!r[t]||!!o&&!!o[t]||!!i.includeFallback&&!!e&&!!e[t]}term(t,...i){let s;let{primary:r,secondary:o}=this.getTranslationData(this.lang());if(r&&r[t])s=r[t];else if(o&&o[t])s=o[t];else{if(!e||!e[t])return console.error(`No translation found for: ${String(t)}`),String(t);s=e[t]}return"function"==typeof s?s(...i):s}date(e,t){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),t).format(e)}number(e,t){return isNaN(e=Number(e))?"":new Intl.NumberFormat(this.lang(),t).format(e)}relativeTime(e,t,i){return new Intl.RelativeTimeFormat(this.lang(),i).format(e,t)}}var tl=class extends tn{},ta=class extends eW{constructor(){super(...arguments),this.localize=new tl(this)}render(){return B`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};ta.styles=e9;var td=new Map,th=new WeakMap;function tc(e,t){return"rtl"===t.toLowerCase()?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function tu(e,t){td.set(e,null!=t?t:{keyframes:[],options:{duration:0}})}function tp(e,t,i){let s=th.get(e);if(null==s?void 0:s[t])return tc(s[t],i.dir);let r=td.get(t);return r?tc(r,i.dir):{keyframes:[],options:{duration:0}}}function tm(e,t,i){return new Promise(s=>{if((null==i?void 0:i.duration)===1/0)throw Error("Promise-based animations must be finite.");let r=e.animate(t,eA(ek({},i),{duration:!function(){let e=window.matchMedia("(prefers-reduced-motion: reduce)");return e.matches}()?i.duration:0}));r.addEventListener("cancel",s,{once:!0}),r.addEventListener("finish",s,{once:!0})})}function tv(e){return Promise.all(e.getAnimations().map(e=>new Promise(t=>{let i=requestAnimationFrame(t);e.addEventListener("cancel",()=>i,{once:!0}),e.addEventListener("finish",()=>i,{once:!0}),e.cancel()})))}function tf(e,t){return e.map(e=>eA(ek({},e),{height:"auto"===e.height?`${t}px`:e.height}))}function tg(e,t,i){return e?t():null==i?void 0:i()}var tb=class extends eW{constructor(){super(...arguments),this.localize=new tl(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}static isTreeItem(e){return e instanceof Element&&"treeitem"===e.getAttribute("role")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&0===this.getChildrenItems().length,this.handleExpandedChange()}async animateCollapse(){this.emit("sl-collapse"),await tv(this.childrenContainer);let{keyframes:e,options:t}=tp(this,"tree-item.collapse",{dir:this.localize.dir()});await tm(this.childrenContainer,tf(e,this.childrenContainer.scrollHeight),t),this.childrenContainer.hidden=!0,this.emit("sl-after-collapse")}isNestedItem(){let e=this.parentElement;return!!e&&tb.isTreeItem(e)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&0===this.getChildrenItems().length}willUpdate(e){e.has("selected")&&!e.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(){this.emit("sl-expand"),await tv(this.childrenContainer),this.childrenContainer.hidden=!1;let{keyframes:e,options:t}=tp(this,"tree-item.expand",{dir:this.localize.dir()});await tm(this.childrenContainer,tf(e,this.childrenContainer.scrollHeight),t),this.childrenContainer.style.height="auto",this.emit("sl-after-expand")}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse()}handleLazyChange(){this.emit("sl-lazy-change")}getChildrenItems({includeDisabled:e=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(t=>tb.isTreeItem(t)&&(e||!t.disabled)):[]}render(){let e="rtl"===this.localize.dir(),t=!this.loading&&(!this.isLeaf||this.lazy);return B`
      <div
        part="base"
        class="${e3({"tree-item":!0,"tree-item--expanded":this.expanded,"tree-item--selected":this.selected,"tree-item--disabled":this.disabled,"tree-item--leaf":this.isLeaf,"tree-item--has-expand-button":t,"tree-item--rtl":"rtl"===this.localize.dir()})}"
      >
        <div
        ...
        >
          ...
          <div
            part="expand-button"
            class=${e3({"tree-item__expand-button":!0,"tree-item__expand-button--visible":t})}
            aria-hidden="true"
          >
            ${tg(this.loading,()=>B` <sl-spinner></sl-spinner> `)}
    ...
    `}};t_.styles=ep,eC([eq("slot:not([name])")],t_.prototype,"defaultSlot",2),eC([eq("slot[name=expand-icon]")],t_.prototype,"expandedIconSlot",2),eC([eq("slot[name=collapse-icon]")],t_.prototype,"collapsedIconSlot",2),eC([eH()],t_.prototype,"selection",2),eC([eR("selection")],t_.prototype,"handleSelectionChange",1),t_.define("sl-tree"),function(...t){t.map(t=>{let i=t.$code.toLowerCase();ti.has(i)?ti.set(i,Object.assign(Object.assign({},ti.get(i)),t)):ti.set(i,t),e||(e=t)}),to()}({$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>0===e?"No options selected":1===e?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"}),tb.define("sl-tree-item"),document.querySelectorAll("sl-tree-item").forEach(e=>{let t=e.firstElementChild;t&&"A"===t.nodeName&&t.addEventListener("click",e=>{e.stopImmediatePropagation()})})})();