...
describe('@memberof tag', function() {
    it('When a symbol has a @member tag, the doclet has a long name that includes the parent.', function() {
        var docSet = jasmine.getDocSetFromFile('test/fixtures/memberoftag.js');
        var Data = docSet.getByLongname('mathlib.Data')[0];
        var point = docSet.getByLongname('mathlib.Data#point')[0];
    ...
    it('A symbol within a namespace for which no scope is specified.', function() {
        ...
        var doOtherStuff = docSet.getByLongname('doStuff.doOtherStuff')[0];
    ...
    it('A symbol in which name === memberof.', function() {
        var docSet = jasmine.getDocSetFromFile('test/fixtures/memberoftag4.js');
        var doStuff = docSet.getByLongname('doStuff.doStuff')[0];
    ...
    describe('static', function() {
        ...
        var publish = docSet.getByLongname('Observable#publish')[0];
        var cache = docSet.getByLongname('Observable.cache')[0];
    ...
    describe('forced', function() {
        ...
        var maproutes = docSet.getByLongname('map.routes')[0];
        var datapointy = docSet.getByLongname('Data#point.y')[0];
    ...
    it('A symbol that is a nested class with a @memberof tag.', function() {
        ...
        var tree = docSet.getByLongname('module:terrain.Forest#Tree')[0];
    ...
    it('A symbol that is an instance member of a nested class with a @memberof tag.', function() {
        var docSet = jasmine.getDocSetFromFile('test/fixtures/memberoftag3.js');
        var leaf = docSet.getByLongname('module:terrain.Forest#Tree#leaf')[0];
