...
exports.addImplemented = function(docs) {
    ...
    this use for mark 'implemented', 'implementProp' property to implements Class's properties (see below blocks)
    ILayer: {
        ...
        owner.forEach(function(cls) {
            ...
            cls.implements.forEach(function(impl) {
                ...
                for (var i = 0, len = props.length; i < len; i++) {
                    ...
                    // mark implemented property by check propertyInfo variable has same impl names.
