...
var TemplateRenderer = function (data, tutorials, options, templateOptions) {
    ...
    // @todo move titles to config
    this.generateGlobalPage('Global');
    this.generateMainPage('Home');
    this.generatePages('Home');
...
TemplateRenderer.prototype.getNavigationMaster = function () {
    return {
        index: {
            title: 'Home',
            link: this.indexUrl,
...
TemplateRenderer.prototype.buildNav = function () {
    var navigationData = this.getNavigationMaster();
...
TemplateRenderer.prototype.generateGlobalPage = function (title) {
    var members = this.getMembers();
...
TemplateRenderer.prototype.generateMainPage = function (title) {
