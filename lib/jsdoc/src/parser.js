...
class Parser extends EventEmitter {
    ...
    clear() {
        ...
        this._byLongname.put(LONGNAMES.GLOBAL, { meta: {} });
    }
    ...
    _getParentClass({enclosingScope}) {
        ...
        while (scope) {
            ...
            if (doclet) {
                ...
                // is the doclet for an instance member of a class? if so, try to get the doclet for
                // the owning class
                nameAtoms = jsdoc.name.atomize(doclet.longname);
